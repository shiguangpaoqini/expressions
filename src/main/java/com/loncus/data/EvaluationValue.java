...
public class EvaluationValue implements Comparable<EvaluationValue> {
  ...
  public enum DataType {
     ...
     */
    EXPRESSION_NODE,
    /** A time series point, stored as {@link TimeSeriesPoint}. The map contains the */
    TIME_SERIES_POINT,
    /** A null value */
    NULL
  }
  ...
  public static EvaluationValue timeSeriesPointValue(TimeSeriesPoint point) {
    return new EvaluationValue(point, DataType.TIME_SERIES_POINT);
  }
  ...
  /**
   * Checks if the value is of type {@link DataType#TIME_SERIES_POINT}.
   *
   * @return <code>true</code> or <code>false</code>.
   */
  public boolean isTimeSeriesPoint() {
    return getDataType() == DataType.TIME_SERIES_POINT;
  }
  ...
  public BigDecimal getNumberValue() {
    switch (getDataType()) {
      ...
      case TIME_SERIES_POINT:
        return ((TimeSeriesPoint) value).getValue();
      case NULL:
        return null;
      default:
  ...
  public String getStringValue() {
    switch (getDataType()) {
      ...
      case TIME_SERIES_POINT:
        return ((TimeSeriesPoint) value).getValue().toPlainString();
      case NULL:
        return null;
      default:
